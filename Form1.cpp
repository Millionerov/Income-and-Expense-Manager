...
namespace ExpenseTrackerApp {
    ...
    Form1::Form1() {
        ...
        this->btnStatistics->Location = Point(880, 43); 
        this->btnStatistics->Size = System::Drawing::Size(100, 27);
        this->btnStatistics->Text = L"📊 Статистика";
        this->btnStatistics->FlatStyle = FlatStyle::Flat;
        this->btnStatistics->Click += gcnew EventHandler(this, &Form1::btnStatistics_Click);
    ...
    void Form1::InitializeComponent() {
        ...
        this->btnStatistics = gcnew Button();
        this->btnStatistics->Location = Point(877, 43);
        this->btnStatistics->Size = System::Drawing::Size(100, 27);
        this->btnStatistics->Text = L"📊 Статистика";
        this->btnStatistics->FlatStyle = FlatStyle::Flat;
        this->btnStatistics->Click += gcnew EventHandler(this, &Form1::btnStatistics_Click);
        ...
        this->labelSearch->Location = Point(987, 47);
        this->labelSearch->Size = System::Drawing::Size(40, 20);

        this->textBoxSearch = gcnew TextBox();
        this->textBoxSearch->Location = Point(1025, 45);
        ...
        this->listViewExpenses->Size = System::Drawing::Size(1160, 380);
        this->listViewExpenses->View = View::Details;
        this->listViewExpenses->FullRowSelect = true;
        this->listViewExpenses->GridLines = true;
        this->listViewExpenses->Anchor = AnchorStyles::Top | AnchorStyles::Bottom | AnchorStyles::Left | AnchorStyles::Right;
        ...
        this->labelIncome->Anchor = AnchorStyles::Bottom | AnchorStyles::Left;
        ...
        this->labelExpense->Anchor = AnchorStyles::Bottom | AnchorStyles::Left;
        ...
        this->labelBalance->Anchor = AnchorStyles::Bottom | AnchorStyles::Left;

        this->labelStats->Location = Point(12, 495);
        this->labelStats->Size = System::Drawing::Size(400, 25);
        this->labelStats->Anchor = AnchorStyles::Bottom | AnchorStyles::Left;

        this->labelBudgetAlert->Location = Point(640, 465);
        this->labelBudgetAlert->Size = System::Drawing::Size(500, 55);
        this->labelBudgetAlert->Font = gcnew Drawing::Font(L"Segoe UI", 9, FontStyle::Bold);
        this->labelBudgetAlert->Visible = false;
        this->labelBudgetAlert->Anchor = AnchorStyles::Bottom | AnchorStyles::Left | AnchorStyles::Right;

        this->statusStrip->Location = Point(0, 530);
        this->statusStrip->Size = System::Drawing::Size(1200, 24);
        ...
        this->ClientSize = System::Drawing::Size(1200, 554);
    ...
    void Form1::btnStatistics_Click(Object^ sender, EventArgs^ e) {
        StatisticsForm^ statsForm = gcnew StatisticsForm(manager);
